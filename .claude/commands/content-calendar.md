...
Check if today's reports already exist before running each script. Skip any script whose report for today is already in `content/research/`.

```bash
python3 research_quick_wins.py
```
Generates `content/research/quick-wins-YYYY-MM-DD.md`

```bash
python3 research_topic_clusters.py
```
Generates `content/research/topic-clusters-YYYY-MM-DD.md`

```bash
python3 research_performance_matrix.py
```
Generates `content/content/research/performance-matrix-YYYY-MM-DD.md`

```bash
python3 research_trending.py
```
Generates `content/content/research/trending-topics-YYYY-MM-DD.md`

Also check for recent competitor gap reports:
- Read `content/research/competitor-gaps-*.md` if any exist (use most recent)
...
Save the calendar to `content/research/content-calendar-YYYY-MM.md` where YYYY-MM is the target month.
...
- `content/research/quick-wins-YYYY-MM-DD.md`
- `content/research/topic-clusters-YYYY-MM-DD.md`
- `content/content/research/performance-matrix-YYYY-MM-DD.md`
- `content/content/research/trending-topics-YYYY-MM-DD.md`
- `content/research/competitor-gaps-*.md` (most recent, if available)

The command creates:
- `content/research/content-calendar-YYYY-MM.md` (month-based naming since it covers a full month)
