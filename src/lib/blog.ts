...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    dateModified: new Date().toISOString().substring(0,10),
    sections: [
      { heading: "Major Changes to Medical Debt Reporting", body: "The credit reporting landscape for medical debt has changed, though not as much as many people believe. Starting in 2022 and 2023, the three major credit bureaus (Equifax, Experian, TransUnion) voluntarily removed paid medical collections from credit reports and stopped reporting medical collections under $500 ,  these bureau policies remain in effect today. Separately, in January 2025 the CFPB finalized a rule that would have removed medical debt from credit reports entirely, but a federal court vacated that rule in July 2025 after finding it exceeded the CFPB's legal authority. As a result, unpaid medical debt of $500 or more can still be reported to the credit bureaus." },
      { heading: "What Medical Debt Still Affects Credit", body: "Unpaid medical collections of $500 or more can still be reported and can still hurt your credit, since the CFPB rule that would have banned this was vacated in court. Medical debt reported before the 2022-2023 bureau policy changes may also still appear until it ages off (typically 7 years from the original delinquency date). Additionally, if a medical creditor obtains a court judgment against you, that judgment may still appear on your credit report. Medical credit cards and personal loans used to pay medical bills are reported as regular consumer debt." },
      { heading: "How to Check Your Credit Report for Medical Debt", body: "Request free copies of your credit reports at AnnualCreditReport.com. Search for any accounts in the collections section with medical provider names. If you find a paid medical collection, or an unpaid one under $500, it should not be there under the credit bureaus' own voluntary policy , dispute it directly with the credit bureau and cite that policy. For unpaid medical debt of $500 or more, the bureau can legally report it, but you should still dispute any entry that is inaccurate, unverified, or not actually yours. The bureau must investigate and remove inaccurate entries within 30 days." },
    ...
    faq: [
      { question: "Does medical debt under $500 appear on my credit report?", answer: "No, medical collections under $500 should not appear, under the credit bureaus' own voluntary policy in effect since 2023. However, unpaid medical debt of $500 or more can still be reported , a 2025 CFPB rule that would have banned this was vacated by a federal court, so it never took lasting effect." },
