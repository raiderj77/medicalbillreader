    ...
    <main id="main-content" className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-700 dark:text-slate-300">
          ...
          <p>
            The explanations of visible charges, code labels, insurance terms, and questions to
            verify provided by this tool do not constitute financial advice. We do not recommend
          ...
          <p>
            Uploaded-document reports are generated by artificial intelligence (AI). The separate
            local worksheet performs arithmetic only and sends no entries to the AI. AI-generated
            explanations may contain errors, omissions, or misinterpretations.
          ...
          <p>
            ...
            or reliability of any analysis provided by this tool. The upload analyzer may attempt to
            identify visible code labels such as CPT, ICD-10-CM, or HCPCS when they are legible, but
            it does not supply official CPT descriptors. A label alone cannot establish coding
            accuracy, coverage, medical necessity, or what you legally owe.
          </p>
